...
async function loadViemUtils() {
  if (!cachedViemUtils) {
    const { createPublicClient, http, defineChain } = await import("./_esm-KVMH7CP3.js");
    cachedViemUtils = {
      createPublicClient,
      http,
      defineChain
...
var controller10 = {
  ...
  subscribeAccountStateProp(property, callback, chain) {
    ...
    return subscribeKey(state16.chains.get(activeChain)?.accountState || {}, property, callback);
  },
...
//# sourceMappingURL=chunk-OQNV3VET.js.map
