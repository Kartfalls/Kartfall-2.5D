...
import {
  ...
  padRight,
  size
} from "./chunk-KIRT3DTZ.js";
import {
  clean,
  createHasher,
  rotl
} from "./chunk-KE327GZJ.js";
import {
  esm_exports,
  require_blakejs,
  require_cjs,
...
function _e(t) {
  ...
  for (let o2 = 0, s2 = 0; o2 < n2; o2++, s2 += 2) {
    const i2 = Lr(t.charCodeAt(s2)), c = Lr(t.charCodeAt(s2 + 1));
...
function nc(t, e = 24) {
  ...
  for (let r2 = 24 - e; r2 < 24; r2++) {
    ...
    for (let i2 = 0; i2 < 10; i2 += 2) {
      const c = (i2 + 8) % 10, f4 = (i2 + 2) % 10, u = n2[f4], a = n2[f4 + 1], l3 = Mr(u, a, 1) ^ n2[c], d3 = Kr(u, a, 1) ^ n2[c + 1];
      for (let h4 = 0; h4 < 50; h4 += 10) t[i2 + h4] ^= l3, t[i2 + h4 + 1] ^= d3;
    }
    let o2 = t[2], s2 = t[3];
    for (let i2 = 0; i2 < 24; i2++) {
      const c = Hr[i2], f4 = Mr(o2, s2, c), u = Kr(o2, s2, c), a = Pr[i2];
...
var Jn = class _Jn extends Re {
  ...
  update(e) {
    ...
    for (let s2 = 0; s2 < o2; ) {
      ...
      for (let c = 0; c < i2; c++) r2[this.pos++] ^= e[s2++];
...
function sc(t, e, n2, r2) {
  ...
  const o2 = BigInt(32), s2 = BigInt(4294967295), i2 = Number(n2 >> o2 & s2), c = Number(n2 & s2), f4 = r2 ? 4 : 0, u = r2 ? 0 : 4;
...
var qr = class extends Re {
  ...
  update(e) {
    ...
    for (let i2 = 0; i2 < s2; ) {
      const c = Math.min(o2 - this.pos, s2 - i2);
      if (c === o2) {
        const f4 = ln(e);
  ...
  digestInto(e) {
    ...
    for (let l3 = i2; l3 < o2; l3++) n2[l3] = 0;
    ...
    for (let l3 = 0; l3 < u; l3++) c.setUint32(4 * l3, a[l3], s2);
  }
  digest() {
  ...
  _cloneInto(e) {
    ...
    const { blockLen: n2, buffer: r2, length: o2, finished: s2, destroyed: i2, pos: c } = this;
    return e.destroyed = i2, e.finished = s2, e.length = o2, e.pos = c, o2 % n2 && e.buffer.set(r2), e;
  }
  clone() {
    return this._cloneInto();
  }
...
var ac = class extends qr {
  ...
  get() {
    const { A: e, B: n2, C: r2, D: o2, E: s2, F: i2, G: c, H: f4 } = this;
    return [e, n2, r2, o2, s2, i2, c, f4];
  }
  set(e, n2, r2, o2, s2, i2, c, f4) {
    this.A = e | 0, this.B = n2 | 0, this.C = r2 | 0, this.D = o2 | 0, this.E = s2 | 0, this.F = i2 | 0, this.G = c | 0, this.H = f4 | 0;
  }
  process(e, n2) {
    for (let l3 = 0; l3 < 16; l3++, n2 += 4) $t[l3] = e.getUint32(n2, false);
    for (let l3 = 16; l3 < 64; l3++) {
      const d3 = $t[l3 - 15], h4 = $t[l3 - 2], y3 = bt(d3, 7) ^ bt(d3, 18) ^ d3 >>> 3, m2 = bt(h4, 17) ^ bt(h4, 19) ^ h4 >>> 10;
      $t[l3] = m2 + $t[l3 - 7] + y3 + $t[l3 - 16] | 0;
    }
    let { A: r2, B: o2, C: s2, D: i2, E: c, F: f4, G: u, H: a } = this;
    for (let l3 = 0; l3 < 64; l3++) {
      const d3 = bt(c, 6) ^ bt(c, 11) ^ bt(c, 25), h4 = a + d3 + ic(c, f4, u) + fc[l3] + $t[l3] | 0, m2 = (bt(r2, 2) ^ bt(r2, 13) ^ bt(r2, 22)) + cc(r2, o2, s2) | 0;
      a = u, u = f4, f4 = c, c = i2 + h4 | 0, i2 = s2, s2 = o2, o2 = r2, r2 = h4 + m2 | 0;
    }
    r2 = r2 + this.A | 0, o2 = o2 + this.B | 0, s2 = s2 + this.C | 0, i2 = i2 + this.D | 0, c = c + this.E | 0, f4 = f4 + this.F | 0, u = u + this.G | 0, a = a + this.H | 0, this.set(r2, o2, s2, i2, c, f4, u, a);
  }
  roundClean() {
    lt($t);
  }
...
var dn = class extends qr {
  ...
  get() {
    const { Ah: e, Al: n2, Bh: r2, Bl: o2, Ch: s2, Cl: i2, Dh: c, Dl: f4, Eh: u, El: a, Fh: l3, Fl: d3, Gh: h4, Gl: y3, Hh: m2, Hl: v } = this;
    return [e, n2, r2, o2, s2, i2, c, f4, u, a, l3, d3, h4, y3, m2, v];
  }
  set(e, n2, r2, o2, s2, i2, c, f4, u, a, l3, d3, h4, y3, m2, v) {
    this.Ah = e | 0, this.Al = n2 | 0, this.Bh = r2 | 0, this.Bl = o2 | 0, this.Ch = s2 | 0, this.Cl = i2 | 0, this.Dh = c | 0, this.Dl = f4 | 0, this.Eh = u | 0, this.El = a | 0, this.Fh = l3 | 0, this.Fl = d3 | 0, this.Gh = h4 | 0, this.Gl = y3 | 0, this.Hh = m2 | 0, this.Hl = v | 0;
  }
  process(e, n2) {
    ...
    let { Ah: r2, Al: o2, Bh: s2, Bl: i2, Ch: c, Cl: f4, Dh: u, Dl: a, Eh: l3, El: d3, Fh: h4, Fl: y3, Gh: m2, Gl: v, Hh: U2, Hl: F } = this;
    for (let R2 = 0; R2 < 80; R2++) {
      const Z = St(l3, d3, 14) ^ St(l3, d3, 18) ^ de(l3, d3, 41), H = Ot(l3, d3, 14) ^ Ot(l3, d3, 18) ^ he(l3, d3, 41), j = l3 & h4 ^ ~l3 & m2, L = d3 & y3 ^ ~d3 & v, k2 = qi(F, H, L, lc[R2], Ct[R2]), O2 = Fi(k2, U2, Z, j, uc[R2], Tt[R2]), T2 = k2 | 0, C4 = St(r2, o2, 28) ^ de(r2, o2, 34) ^ de(r2, o2, 39), _ = Ot(r2, o2, 28) ^ he(r2, o2, 34) ^ he(r2, o2, 39), p = r2 & s2 ^ r2 & c ^ s2 & c, b = o2 & i2 ^ o2 & f4 ^ i2 & f4;
      U2 = m2 | 0, F = v | 0, m2 = h4 | 0, v = y3 | 0, h4 = l3 | 0, y3 = d3 | 0, { h: l3, l: d3 } = dt(u | 0, a | 0, O2 | 0, T2 | 0), u = c | 0, a = f4 | 0, c = s2 | 0, f4 = i2 | 0, s2 = r2 | 0, i2 = o2 | 0;
      const g = fn(T2, _, b);
      r2 = an(g, O2, C4, p), o2 = g | 0;
    }
    ({ h: r2, l: o2 } = dt(this.Ah | 0, this.Al | 0, r2 | 0, o2 | 0)), { h: s2, l: i2 } = dt(this.Bh | 0, this.Bl | 0, s2 | 0, i2 | 0), { h: c, l: f4 } = dt(this.Ch | 0, this.Cl | 0, c | 0, f4 | 0), { h: u, l: a } = dt(this.Dh | 0, this.Dl | 0, u | 0, a | 0), { h: l3, l: d3 } = dt(this.Eh | 0, this.El | 0, l3 | 0, d3 | 0), { h: h4, l: y3 } = dt(this.Fh | 0, this.Fl | 0, h4 | 0, y3 | 0), { h: m2, l: v } = dt(this.Gh | 0, this.Gl | 0, m2 | 0, v | 0), { h: U2, l: F } = dt(this.Hh | 0, this.Hl | 0, U2 | 0, F | 0), this.set(r2, o2, s2, i2, c, f4, u, a, l3, d3, h4, y3, m2, v, U2, F);
  }
  roundClean() {
    lt(Tt, Ct);
  }
...
function jt(t, e, n2, r2, o2, s2) {
  const i2 = o2[s2], c = o2[s2 + 1];
  let f4 = S[2 * t], u = S[2 * t + 1], a = S[2 * e], l3 = S[2 * e + 1], d3 = S[2 * n2], h4 = S[2 * n2 + 1], y3 = S[2 * r2], m2 = S[2 * r2 + 1], v = fn(f4, a, i2);
  u = an(v, u, l3, c), f4 = v | 0, { Dh: m2, Dl: y3 } = { Dh: m2 ^ u, Dl: y3 ^ f4 }, { Dh: m2, Dl: y3 } = { Dh: Li(m2, y3), Dl: ki(m2) }, { h: h4, l: d3 } = dt(h4, d3, m2, y3), { Bh: l3, Bl: a } = { Bh: l3 ^ h4, Bl: a ^ d3 }, { Bh: l3, Bl: a } = { Bh: St(l3, a, 24), Bl: Ot(l3, a, 24) }, S[2 * t] = f4, S[2 * t + 1] = u, S[2 * e] = a, S[2 * e + 1] = l3, S[2 * n2] = d3, S[2 * n2 + 1] = h4, S[2 * r2] = y3, S[2 * r2 + 1] = m2;
}
function Lt(t, e, n2, r2, o2, s2) {
  const i2 = o2[s2], c = o2[s2 + 1];
  let f4 = S[2 * t], u = S[2 * t + 1], a = S[2 * e], l3 = S[2 * e + 1], d3 = S[2 * n2], h4 = S[2 * n2 + 1], y3 = S[2 * r2], m2 = S[2 * r2 + 1], v = fn(f4, a, i2);
  u = an(v, u, l3, c), f4 = v | 0, { Dh: m2, Dl: y3 } = { Dh: m2 ^ u, Dl: y3 ^ f4 }, { Dh: m2, Dl: y3 } = { Dh: St(m2, y3, 16), Dl: Ot(m2, y3, 16) }, { h: h4, l: d3 } = dt(h4, d3, m2, y3), { Bh: l3, Bl: a } = { Bh: l3 ^ h4, Bl: a ^ d3 }, { Bh: l3, Bl: a } = { Bh: de(l3, a, 63), Bl: he(l3, a, 63) }, S[2 * t] = f4, S[2 * t + 1] = u, S[2 * e] = a, S[2 * e + 1] = l3, S[2 * n2] = d3, S[2 * n2 + 1] = h4, S[2 * r2] = y3, S[2 * r2 + 1] = m2;
}
function mc(t, e = {}, n2, r2, o2) {
  if (mt(n2), t < 0 || t > n2) throw new Error("outputLen bigger than keyLen");
  const { key: s2, salt: i2, personalization: c } = e;
...
var wc = class extends Re {
  ...
  update(e) {
    Nt(this), e = pt(e), ht(e);
    const { blockLen: n2, buffer: r2, buffer32: o2 } = this, s2 = e.length, i2 = e.byteOffset, c = e.buffer;
    for (let f4 = 0; f4 < s2; ) {
      this.pos === n2 && (Ut(o2), this.compress(o2, 0, false), Ut(o2), this.pos = 0);
      const u = Math.min(n2 - this.pos, s2 - f4), a = i2 + f4;
      if (u === n2 && !(a % 4) && f4 + u < s2) {
        const l3 = new Uint32Array(c, a, Math.floor((s2 - f4) / 4));
        Ut(l3);
        for (let d3 = 0; f4 + n2 < s2; d3 += o2.length, f4 += n2) this.length += n2, this.compress(l3, d3, false);
        Ut(l3);
        continue;
      }
  ...
  _cloneInto(e) {
    const { buffer: n2, length: r2, finished: o2, destroyed: s2, outputLen: i2, pos: c } = this;
    return e || (e = new this.constructor({ dkLen: i2 })), e.set(...this.get()), e.buffer.set(n2), e.destroyed = s2, e.finished = o2, e.length = r2, e.pos = c, e.outputLen = i2, e;
  }
  clone() {
    return this._cloneInto();
  }
...
var vc = class extends wc {
  ...
  get() {
    let { v0l: e, v0h: n2, v1l: r2, v1h: o2, v2l: s2, v2h: i2, v3l: c, v3h: f4, v4l: u, v4h: a, v5l: l3, v5h: d3, v6l: h4, v6h: y3, v7l: m2, v7h: v } = this;
    return [e, n2, r2, o2, s2, i2, c, f4, u, a, l3, d3, h4, y3, m2, v];
  }
  set(e, n2, r2, o2, s2, i2, c, f4, u, a, l3, d3, h4, y3, m2, v) {
    this.v0l = e | 0, this.v0h = n2 | 0, this.v1l = r2 | 0, this.v1h = o2 | 0, this.v2l = s2 | 0, this.v2h = i2 | 0, this.v3l = c | 0, this.v3h = f4 | 0, this.v4l = u | 0, this.v4h = a | 0, this.v5l = l3 | 0, this.v5h = d3 | 0, this.v6l = h4 | 0, this.v6h = y3 | 0, this.v7l = m2 | 0, this.v7h = v | 0;
  }
  compress(e, n2, r2) {
...
var Xc = (t, e) => {
  function n2(r2, ...o2) {
    ...
    return { encrypt(a, l3) {
      ...
      return f4 = true, ot(a), c(i2.encrypt.length, l3), i2.encrypt(a, l3);
    }, decrypt(a, l3) {
      if (ot(a), s2 && a.length < s2) throw new Error("invalid ciphertext length: smaller than tagLength=" + s2);
      return c(i2.decrypt.length, l3), i2.decrypt(a, l3);
    } };
  }
...
function sf(t, e, n2, r2, o2, s2, i2, c) {
  const f4 = o2.length, u = new Uint8Array(Le), a = Pt(u), l3 = An(o2) && An(s2), d3 = l3 ? Pt(o2) : mo, h4 = l3 ? Pt(s2) : mo;
...
function cf(t, e) {
  ...
  return xn(o2), xn(i2), vn(s2), vn(n2), (c, f4, u, a, l3 = 0) => {
    ot(c), ot(f4), ot(u);
    const d3 = u.length;
    if (a === void 0 && (a = new Uint8Array(d3)), ot(a), xn(l3), l3 < 0 || l3 >= yo) throw new Error("arx: counter overflow");
    if (a.length < d3) throw new Error(`arx: output (${a.length}) is shorter than data (${d3})`);
    const h4 = [];
    let y3 = c.length, m2, v;
    if (y3 === 32) h4.push(m2 = Bn(c)), v = rf;
    else if (y3 === 16 && n2) m2 = new Uint8Array(32), m2.set(c), m2.set(c, 16), v = nf, h4.push(m2);
    ...
    const R2 = Pt(f4);
    return sf(t, v, U2, R2, u, a, l3, i2), Qt(...h4), a;
  };
}
...
var ff = class {
  constructor(e) {
    ...
    const n2 = W(e, 0), r2 = W(e, 2), o2 = W(e, 4), s2 = W(e, 6), i2 = W(e, 8), c = W(e, 10), f4 = W(e, 12), u = W(e, 14);
    this.r[0] = n2 & 8191, this.r[1] = (n2 >>> 13 | r2 << 3) & 8191, this.r[2] = (r2 >>> 10 | o2 << 6) & 7939, this.r[3] = (o2 >>> 7 | s2 << 9) & 8191, this.r[4] = (s2 >>> 4 | i2 << 12) & 255, this.r[5] = i2 >>> 1 & 8190, this.r[6] = (i2 >>> 14 | c << 2) & 8191, this.r[7] = (c >>> 11 | f4 << 5) & 8065, this.r[8] = (f4 >>> 8 | u << 8) & 8191, this.r[9] = u >>> 5 & 127;
    for (let a = 0; a < 8; a++) this.pad[a] = W(e, 16 + 2 * a);
  }
  process(e, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: s2, r: i2 } = this, c = i2[0], f4 = i2[1], u = i2[2], a = i2[3], l3 = i2[4], d3 = i2[5], h4 = i2[6], y3 = i2[7], m2 = i2[8], v = i2[9], U2 = W(e, n2 + 0), F = W(e, n2 + 2), R2 = W(e, n2 + 4), Z = W(e, n2 + 6), H = W(e, n2 + 8), j = W(e, n2 + 10), L = W(e, n2 + 12), k2 = W(e, n2 + 14);
    let O2 = s2[0] + (U2 & 8191), T2 = s2[1] + ((U2 >>> 13 | F << 3) & 8191), C4 = s2[2] + ((F >>> 10 | R2 << 6) & 8191), _ = s2[3] + ((R2 >>> 7 | Z << 9) & 8191), p = s2[4] + ((Z >>> 4 | H << 12) & 8191), b = s2[5] + (H >>> 1 & 8191), g = s2[6] + ((H >>> 14 | j << 2) & 8191), x = s2[7] + ((j >>> 11 | L << 5) & 8191), E2 = s2[8] + ((L >>> 8 | k2 << 8) & 8191), A3 = s2[9] + (k2 >>> 5 | o2), w = 0, B = w + O2 * c + T2 * (5 * v) + C4 * (5 * m2) + _ * (5 * y3) + p * (5 * h4);
    w = B >>> 13, B &= 8191, B += b * (5 * d3) + g * (5 * l3) + x * (5 * a) + E2 * (5 * u) + A3 * (5 * f4), w += B >>> 13, B &= 8191;
    let I2 = w + O2 * f4 + T2 * c + C4 * (5 * v) + _ * (5 * m2) + p * (5 * y3);
    w = I2 >>> 13, I2 &= 8191, I2 += b * (5 * h4) + g * (5 * d3) + x * (5 * l3) + E2 * (5 * a) + A3 * (5 * u), w += I2 >>> 13, I2 &= 8191;
    let N2 = w + O2 * u + T2 * f4 + C4 * c + _ * (5 * v) + p * (5 * m2);
    w = N2 >>> 13, N2 &= 8191, N2 += b * (5 * y3) + g * (5 * h4) + x * (5 * d3) + E2 * (5 * l3) + A3 * (5 * a), w += N2 >>> 13, N2 &= 8191;
    let D = w + O2 * a + T2 * u + C4 * f4 + _ * c + p * (5 * v);
    w = D >>> 13, D &= 8191, D += b * (5 * m2) + g * (5 * y3) + x * (5 * h4) + E2 * (5 * d3) + A3 * (5 * l3), w += D >>> 13, D &= 8191;
    let P2 = w + O2 * l3 + T2 * a + C4 * u + _ * f4 + p * c;
    w = P2 >>> 13, P2 &= 8191, P2 += b * (5 * v) + g * (5 * m2) + x * (5 * y3) + E2 * (5 * h4) + A3 * (5 * d3), w += P2 >>> 13, P2 &= 8191;
    let $3 = w + O2 * d3 + T2 * l3 + C4 * a + _ * u + p * f4;
    w = $3 >>> 13, $3 &= 8191, $3 += b * c + g * (5 * v) + x * (5 * m2) + E2 * (5 * y3) + A3 * (5 * h4), w += $3 >>> 13, $3 &= 8191;
    let V2 = w + O2 * h4 + T2 * d3 + C4 * l3 + _ * a + p * u;
    w = V2 >>> 13, V2 &= 8191, V2 += b * f4 + g * c + x * (5 * v) + E2 * (5 * m2) + A3 * (5 * y3), w += V2 >>> 13, V2 &= 8191;
    let q2 = w + O2 * y3 + T2 * h4 + C4 * d3 + _ * l3 + p * a;
    w = q2 >>> 13, q2 &= 8191, q2 += b * u + g * f4 + x * c + E2 * (5 * v) + A3 * (5 * m2), w += q2 >>> 13, q2 &= 8191;
    let G2 = w + O2 * m2 + T2 * y3 + C4 * h4 + _ * d3 + p * l3;
    w = G2 >>> 13, G2 &= 8191, G2 += b * a + g * u + x * f4 + E2 * c + A3 * (5 * v), w += G2 >>> 13, G2 &= 8191;
    let M2 = w + O2 * v + T2 * m2 + C4 * y3 + _ * h4 + p * d3;
    w = M2 >>> 13, M2 &= 8191, M2 += b * l3 + g * a + x * u + E2 * f4 + A3 * c, w += M2 >>> 13, M2 &= 8191, w = (w << 2) + w | 0, w = w + B | 0, B = w & 8191, w = w >>> 13, I2 += w, s2[0] = B, s2[1] = I2, s2[2] = N2, s2[3] = D, s2[4] = P2, s2[5] = $3, s2[6] = V2, s2[7] = q2, s2[8] = G2, s2[9] = M2;
  }
  finalize() {
    ...
    r2[9] -= 8192;
    let s2 = (o2 ^ 1) - 1;
    for (let c = 0; c < 10; c++) r2[c] &= s2;
    s2 = ~s2;
    for (let c = 0; c < 10; c++) e[c] = e[c] & s2 | r2[c];
...
function lf(t, e, n2, r2, o2, s2 = 20) {
  let i2 = t[0], c = t[1], f4 = t[2], u = t[3], a = e[0], l3 = e[1], d3 = e[2], h4 = e[3], y3 = e[4], m2 = e[5], v = e[6], U2 = e[7], F = o2, R2 = n2[0], Z = n2[1], H = n2[2], j = i2, L = c, k2 = f4, O2 = u, T2 = a, C4 = l3, _ = d3, p = h4, b = y3, g = m2, x = v, E2 = U2, A3 = F, w = R2, B = Z, I2 = H;
  ...
  let N2 = 0;
  r2[N2++] = i2 + j | 0, r2[N2++] = c + L | 0, r2[N2++] = f4 + k2 | 0, r2[N2++] = u + O2 | 0, r2[N2++] = a + T2 | 0, r2[N2++] = l3 + C4 | 0, r2[N2++] = d3 + _ | 0, r2[N2++] = h4 + p | 0, r2[N2++] = y3 + b | 0, r2[N2++] = m2 + g | 0, r2[N2++] = v + x | 0, r2[N2++] = U2 + E2 | 0, r2[N2++] = F + A3 | 0, r2[N2++] = R2 + w | 0, r2[N2++] = Z + B | 0, r2[N2++] = H + I2 | 0;
}
...
function vo(t, e, n2, r2, o2) {
  ...
  const c = Jc(r2.length, o2 ? o2.length : 0, true);
  i2.update(c);
  const f4 = i2.digest();
  return Qt(s2, c), f4;
}
var gf = (t) => (e, n2, r2) => ({ encrypt(s2, i2) {
  ...
  const c = s2.subarray(0, -16), f4 = s2.subarray(-16), u = vo(t, e, n2, c, r2);
...
var Eo = class extends Re {
  ...
  _cloneInto(e) {
    ...
    const { oHash: n2, iHash: r2, finished: o2, destroyed: s2, blockLen: i2, outputLen: c } = this;
    return e = e, e.finished = o2, e.destroyed = s2, e.blockLen = i2, e.outputLen = c, e.oHash = n2._cloneInto(e.oHash), e.iHash = r2._cloneInto(e.iHash), e;
  }
  clone() {
    return this._cloneInto();
  }
...
function Kt(t, e, n2 = "") {
  ...
  if (!r2 || s2 && o2 !== e) {
    const i2 = n2 && `"${n2}" `, c = s2 ? ` of length ${e}` : "", f4 = r2 ? `length=${o2}` : `type=${typeof t}`;
...
function vf(t, e, n2) {
  ...
  let s2 = r2(t), i2 = r2(t), c = 0;
  const f4 = () => {
    s2.fill(1), i2.fill(0), c = 0;
...
function Ke(t, e, n2 = {}) {
  ...
  function r2(o2, s2, i2) {
    ...
    const f4 = typeof c;
    if (f4 !== s2 || c === null) throw new Error(`param "${o2}" is invalid: expected ${s2}, got ${f4}`);
  }
...
function $o(t, e) {
  ...
  for (; n2 !== st; ) {
    const c = r2 / n2, f4 = r2 % n2, u = o2 - s2 * c;
...
function Bf(t, e) {
  const n2 = (t.ORDER - Uo) / _o, r2 = t.mul(e, qt), o2 = t.pow(r2, n2), s2 = t.mul(e, o2), i2 = t.mul(t.mul(s2, qt), o2), c = t.mul(s2, t.sub(i2, t.ONE));
  return $n(t, c, e), c;
}
function Af(t) {
  ...
  return (c, f4) => {
    ...
    const l3 = c.mul(u, o2), d3 = c.mul(u, s2), h4 = c.eql(c.sqr(a), f4), y3 = c.eql(c.sqr(l3), f4);
    u = c.cmov(u, a, h4), a = c.cmov(d3, l3, y3);
...
function Co(t) {
  ...
  return function(f4, u) {
    ...
    let a = n2, l3 = f4.mul(f4.ONE, s2), d3 = f4.pow(u, e), h4 = f4.pow(u, i2);
    for (; !f4.eql(d3, f4.ONE); ) {
      ...
      const v = nt << BigInt(a - y3 - 1), U2 = f4.pow(l3, v);
      a = y3, l3 = f4.sqr(U2), d3 = f4.mul(d3, l3), h4 = f4.mul(h4, U2);
    }
    return h4;
  };
}
...
function jo(t, e, n2 = false) {
  const r2 = new Array(e.length).fill(n2 ? t.ZERO : void 0), o2 = e.reduce((i2, c, f4) => t.is0(c) ? i2 : (r2[f4] = i2, t.mul(i2, c)), t.ONE), s2 = t.inv(o2);
  return e.reduceRight((i2, c, f4) => t.is0(c) ? i2 : (r2[f4] = t.mul(i2, r2[f4]), t.mul(i2, c)), s2), r2;
}
function Lo(t, e) {
...
function Ht(t, e, n2 = false, r2 = {}) {
  ...
  let o2, s2, i2 = false, c;
  if (typeof e == "object" && e != null) {
    if (r2.sqrt || n2) throw new Error("cannot specify opts in two arguments");
    const d3 = e;
    d3.BITS && (o2 = d3.BITS), d3.sqrt && (s2 = d3.sqrt), typeof d3.isLE == "boolean" && (n2 = d3.isLE), typeof d3.modFromBytes == "boolean" && (i2 = d3.modFromBytes), c = d3.allowedLengths;
  ...
  let a;
  const l3 = Object.freeze({ ORDER: t, isLE: n2, BITS: f4, BYTES: u, MASK: ye(f4), ZERO: st, ONE: nt, allowedLengths: c, create: (d3) => ct(d3, t), isValid: (d3) => {
    if (typeof d3 != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof d3);
    return st <= d3 && d3 < t;
  }, is0: (d3) => d3 === st, isValidNot0: (d3) => !l3.is0(d3) && l3.isValid(d3), isOdd: (d3) => (d3 & nt) === nt, neg: (d3) => ct(-d3, t), eql: (d3, h4) => d3 === h4, sqr: (d3) => ct(d3 * d3, t), add: (d3, h4) => ct(d3 + h4, t), sub: (d3, h4) => ct(d3 - h4, t), mul: (d3, h4) => ct(d3 * h4, t), pow: (d3, h4) => Nf(l3, d3, h4), div: (d3, h4) => ct(d3 * $o(h4, t), t), sqrN: (d3) => d3 * d3, addN: (d3, h4) => d3 + h4, subN: (d3, h4) => d3 - h4, mulN: (d3, h4) => d3 * h4, inv: (d3) => $o(d3, t), sqrt: s2 || ((d3) => (a || (a = If(t)), a(l3, d3))), toBytes: (d3) => n2 ? Un(d3, u) : Nn(d3, u), fromBytes: (d3, h4 = true) => {
    if (c) {
    ...
    if (i2 && (y3 = ct(y3, t)), !h4 && !l3.isValid(y3)) throw new Error("invalid field element: outside of range 0..ORDER");
    return y3;
  }, invertBatch: (d3) => jo(l3, d3), cmov: (d3, h4, y3) => y3 ? h4 : d3 });
...
function Vo(t, e, n2) {
  ...
  c > r2 && (c -= s2, f4 += Ft);
  const u = e * r2, a = u + Math.abs(c) - 1, l3 = c === 0, d3 = c < 0, h4 = e % 2 !== 0;
  return { nextN: f4, offset: a, isZero: l3, isNeg: d3, isNegF: h4, offsetF: u };
}
function _f(t, e) {
...
var $f = class {
  ...
  precomputeWindow(e, n2) {
    ...
    for (let f4 = 0; f4 < r2; f4++) {
      c = i2, s2.push(c);
      for (let u = 1; u < o2; u++) c = c.add(i2), s2.push(c);
      i2 = c.double();
    }
    return s2;
  }
  wNAF(e, n2, r2) {
    ...
    for (let c = 0; c < i2.windows; c++) {
      const { nextN: f4, offset: u, isZero: a, isNeg: l3, isNegF: d3, offsetF: h4 } = Vo(r2, c, i2);
      r2 = f4, a ? s2 = s2.add(qe(d3, n2[h4])) : o2 = o2.add(qe(l3, n2[u]));
    }
  ...
  wNAFUnsafe(e, n2, r2, o2 = this.ZERO) {
    ...
    for (let i2 = 0; i2 < s2.windows && r2 !== te; i2++) {
      const { nextN: c, offset: f4, isZero: u, isNeg: a } = Vo(r2, i2, s2);
      if (r2 = c, !u) {
        const l3 = n2[f4];
        o2 = o2.add(a ? l3.negate() : l3);
      }
    }
    return Ko(r2), o2;
  }
...
function Cf(t, e, n2, r2) {
  ...
  const u = ye(f4), a = new Array(Number(u) + 1).fill(i2), l3 = Math.floor((e.BITS - 1) / f4) * f4;
  let d3 = i2;
  for (let h4 = l3; h4 >= 0; h4 -= f4) {
    a.fill(i2);
...
function jf(t, e, n2 = {}, r2) {
  ...
  const o2 = qo(e.p, n2.Fp, r2), s2 = qo(e.n, n2.Fn, r2), c = ["Gx", "Gy", "a", t === "weierstrass" ? "b" : "d"];
...
function kf(t) {
  const e = Lf(t), { P: n2, type: r2, adjustScalarBytes: o2, powPminus2: s2, randomBytes: i2 } = e, c = r2 === "x25519";
  if (!c && r2 !== "x448") throw new Error("invalid type");
  const f4 = i2 || Mt, u = c ? 255 : 448, a = c ? 32 : 56, l3 = BigInt(c ? 9 : 5), d3 = BigInt(c ? 121665 : 39081), h4 = c ? Fe ** BigInt(254) : Fe ** BigInt(447), y3 = c ? BigInt(8) * Fe ** BigInt(251) - ee : BigInt(4) * Fe ** BigInt(445) - ee, m2 = h4 + y3 + ee, v = (p) => ct(p, n2), U2 = F(l3);
  function F(p) {
    return Un(v(p), a);
  }
  function R2(p) {
...
function Kf(t) {
  const e = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), s2 = Zo, c = t * t % s2 * t % s2, f4 = gt(c, Fo, s2) * c % s2, u = gt(f4, Pf, s2) * t % s2, a = gt(u, Df, s2) * u % s2, l3 = gt(a, e, s2) * a % s2, d3 = gt(l3, n2, s2) * l3 % s2, h4 = gt(d3, r2, s2) * d3 % s2, y3 = gt(h4, o2, s2) * h4 % s2, m2 = gt(y3, o2, s2) * h4 % s2, v = gt(m2, e, s2) * a % s2;
  return { pow_p_5_8: gt(v, Fo, s2) * t % s2, b2: c };
}
function qf(t) {
...
function Zf(t, e, n2) {
  const [[r2, o2], [s2, i2]] = e, c = Go(i2 * t, n2), f4 = Go(-o2 * t, n2);
  let u = t - c * r2 - f4 * s2, a = -c * o2 - f4 * i2;
  const l3 = u < Et, d3 = a < Et;
  l3 && (u = -u), d3 && (a = -a);
  const h4 = ye(Math.ceil(Io(n2) / 2)) + ne;
  if (u < Et || u >= h4 || a < Et || a >= h4) throw new Error("splitScalar (endomorphism): failed, k=" + t);
  return { k1neg: l3, k1: u, k2neg: d3, k2: a };
}
function Pn(t) {
...
var xt = { Err: Gf, _tlv: { encode: (t, e) => {
  ...
  const { v: c, l: f4 } = r2.decode(2, s2), { v: u, l: a } = r2.decode(2, f4);
...
function Yf(t, e = {}) {
  ...
  const h4 = e.toBytes || l3, y3 = e.fromBytes || d3;
  function m2(_) {
...
function Wf(t, e = {}) {
  ...
  return Object.freeze({ getPublicKey: f4, getSharedSecret: l3, keygen: u, Point: t, utils: { isValidSecretKey: s2, isValidPublicKey: i2, randomSecretKey: c, isValidPrivateKey: s2, randomPrivateKey: c, normPrivateKeyToScalar: (h4) => re(n2, h4), precompute(h4 = 8, y3 = t.BASE) {
...
function Xf(t, e, n2 = {}) {
  ...
  const r2 = n2.randomBytes || Mt, o2 = n2.hmac || ((b, ...g) => ke(e, b, _t(...g))), { Fp: s2, Fn: i2 } = t, { ORDER: c, BITS: f4 } = i2, { keygen: u, getPublicKey: a, getSharedSecret: l3, utils: d3, lengths: h4 } = Wf(t, n2), y3 = { prehash: false, lowS: typeof n2.lowS == "boolean" ? n2.lowS : false, format: void 0, extraEntropy: false }, m2 = "compact";
  function v(b) {
    const g = c >> ne;
    return b > g;
  }
  ...
  return Object.freeze({ keygen: u, getPublicKey: a, getSharedSecret: l3, utils: d3, lengths: h4, Point: t, sign: T2, verify: _, recoverPublicKey: p, Signature: R2, hash: e });
}
function Jf(t) {
...
function cr(r2, e) {
  ...
  var a = r2.length, c = r2.charAt(0), h4 = Math.log(a) / Math.log(256), l3 = Math.log(256) / Math.log(a);
  function p(u) {
...
var mr = (r2, e, t, i2) => {
  ...
  for (let l3 = 0; l3 < n2; ++l3) {
    ...
    c = c << t | p, a += t, a >= 8 && (a -= 8, o2[h4++] = 255 & c >> a);
  }
...
var fr = (r2, e, t) => {
  ...
  let n2 = "", o2 = 0, a = 0;
  for (let c = 0; c < r2.length; ++c) for (a = a << 8 | r2[c], o2 += 8; o2 > t; ) o2 -= t, n2 += e[s2 & a >> o2];
...
var ChildPart = class _ChildPart {
  ...
  _$clear(start = wrap(this._$startNode).nextSibling, from6) {
    this._$notifyConnectionChanged?.(false, true, from6);
...
(global4.reactiveElementVersions ??= []).push("2.1.2");
...
(global5.litElementVersions ??= []).push("4.2.2");
...
//# sourceMappingURL=chunk-URZV2BPC.js.map
