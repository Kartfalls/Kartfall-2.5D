 ...
 */
export type CoinbaseOnRampInitInput =
  | CoinbaseOnRampInitInput.UnionMember0
  | CoinbaseOnRampInitInput.UnionMember1;

export namespace CoinbaseOnRampInitInput {
...
export type MoonpayOnRampSignInput =
  | MoonpayOnRampSignInput.UnionMember0
  | MoonpayOnRampSignInput.UnionMember1;
