import{jsxs as e,jsx as r,Fragment as o}from"react/jsx-runtime";import n from"@heroicons/react/24/outline/DevicePhoneMobileIcon";import i from"@heroicons/react/24/outline/FingerPrintIcon";import t from"@heroicons/react/24/outline/PhoneIcon";import a from"@heroicons/react/24/outline/ShieldCheckIcon";import{b as s,M as c,P as l,S as d}from"./ModalHeader-DpkEBdQv.mjs";import{S as h}from"./ScreenLayout-CyK-vOMq.mjs";import{A as m,C as p,N as u}from"./useActiveWallet-DMrO7evY.mjs";import{M as g,F as f,T as y,L as C,b as k,c as T,C as S,E as b,P as v,I,N as w,S as j}from"./PinInput-3SLvbnQa.mjs";import P from"@heroicons/react/24/outline/CalendarIcon";import x from"@heroicons/react/24/outline/ExclamationTriangleIcon";import{e as B}from"./StackedContainer-B2vaEl56.mjs";import{u as E}from"./internal-context-Z-fyxadS.mjs";import{useState as M,useMemo as A,useEffect as V}from"react";import{styled as L}from"styled-components";import{toHex as N}from"viem";import{u as D}from"./useGetTokenPrice-N5ZX6Yun.mjs";import{u as F,a as Y}from"./useWallets-CS_W9ciB.mjs";import{p as H,j as W,g as G,h as O}from"./index-DQp_5KKJ.mjs";import{T as Q}from"./TransactionDetails-D9GBw9C3.mjs";import{u as q}from"./context-Bj4czVEP.mjs";const z=({handleClose:o,mfaMethods:c,onSelect:l})=>/*#__PURE__*/e(h,{title:"Verify your identity",subtitle:"Choose a verification method",icon:a,iconVariant:"subtle",onClose:o,showClose:!0,watermark:!0,children:[/*#__PURE__*/e(g,{children:[c.includes("totp")&&/*#__PURE__*/e(m,{onClick:()=>l("totp"),children:[/*#__PURE__*/r(p,{children:/*#__PURE__*/r(n,{})}),"Authenticator app"]},"totp"),c.includes("sms")&&/*#__PURE__*/e(m,{onClick:()=>l("sms"),children:[/*#__PURE__*/r(p,{children:/*#__PURE__*/r(t,{})}),"SMS"]},"sms"),c.includes("passkey")&&/*#__PURE__*/e(m,{onClick:()=>l("passkey"),children:[/*#__PURE__*/r(p,{children:/*#__PURE__*/r(i,{})}),"Passkey"]},"passkey")]}),/*#__PURE__*/r(s,{})]}),J=({pendingTransaction:e})=>{let{wallets:o}=F(),{walletProxy:n,rpcConfig:i,chains:t,appId:a,nativeTokenSymbolForChainId:s}=E(),[c,l]=M(null),[d,h]=M(e),{tokenPrice:m}=D(d.chainId),p=s(e.chainId)||"ETH",u=A((()=>o.find((e=>"privy"===e.walletClientType))),[o]);return V((()=>{(async function(){if(!n||!u)return d;let e=Y(d.chainId,t,i,{appId:a}),r=await H(d,e,u.address);return l(N(BigInt(r.gas??0))),r})().then(h).catch(console.error)}),[n]),u?/*#__PURE__*/r(K,{children:/*#__PURE__*/r(Q,{from:u.address,to:d.to,txn:d,gas:c??void 0,tokenPrice:m,tokenSymbol:p})}):null};let K=L.div`
  width: 100%;
  padding: 1rem 0;
