"use strict";var e=require("react/jsx-runtime"),t=require("@heroicons/react/24/outline/UserCircleIcon"),i=require("react"),a=require("styled-components"),l=require("./ModalHeader-DGIBNq1A.js"),r=require("./context-DTLyrNSs.js"),n=require("./useActiveWallet-DEJxYDtx.js"),s=require("./internal-context-BJv4f_bO.js"),o=require("./privy-context-CqCBaHHR.js"),d=require("./index-BbTBzvbB.js"),c=require("./ConnectWalletView-CWInrfMx.js"),p=require("./use-export-wallet-CJFX3PX0.js"),u=require("lucide-react"),h=require("./ConnectEmailForm-BBb0J8Qw.js"),g=require("./Chip-C6r7fZiR.js"),y=require("./farcaster-CWHXGAib.js"),m=require("@privy-io/js-sdk-core"),f=require("@heroicons/react/24/outline/QuestionMarkCircleIcon"),x=require("@heroicons/react/24/outline/FingerPrintIcon"),j=require("./Link-BdtTp2J4.js"),w=require("./ConnectPhoneForm-Cz02aWfj.js"),v=require("./twitter-CJSxxOMI.js"),C=require("./twitch-BNvhZb2Y.js"),b=require("./telegram-D3O0_F1a.js"),S=require("./WalletOverflowButton-B81EzN7L.js"),k=require("./ScreenLayout-yf03MRVf.js");function M(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var T=/*#__PURE__*/M(t),L=/*#__PURE__*/M(i),A=/*#__PURE__*/M(f),W=/*#__PURE__*/M(x);const P=()=>{let t=r.useAppConfig(),i=t?.appearance?.logo,a=`${t?.name} logo`,l={maxHeight:"90px",maxWidth:"180px"};return i?"string"==typeof i?/*#__PURE__*/e.jsx("img",{src:i,alt:a,style:l}):"svg"===i.type||"img"===i.type?/*#__PURE__*/L.default.cloneElement(i,{alt:a,style:l}):(console.warn("`config.appearance.logo` must be a string, or an SVG / IMG element. Nothing will be rendered."),null):null},I=a.styled.div`
  display: flex;
